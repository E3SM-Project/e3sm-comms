...
# scp wordpress_pages.xml user@host:/path/to/e3sm-comms-io/input/exported_xml_reviewer/wordpress_pages.xml
# scp wordpress_posts.xml user@host:/path/to/e3sm-comms-io/input/exported_xml_reviewer/wordpress_posts.xml

# WordPress: CMP Settings > CMP Advanced Setup: copy the list of pages to ${IO_DIR}/input/exported_xml_reviewer/whitelisted_web_pages.txt

# Replace this with your IO dir!
...
e3sm-comms-exported-xml-reviewer --use-confluence --use-whitelist
echo "Output reports:"
