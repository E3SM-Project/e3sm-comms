...
# scp local_path/wordpress_pages.xml forsyth@perlmutter.nersc.gov:perlmutter_path/wordpress_pages.xml
# scp local_path/wordpress_posts.xml forsyth@perlmutter.nersc.gov:perlmutter_path/wordpress_posts.xml

# WordPress: CMP Settings > CMP Advanced Setup: copy the list of pages to /global/homes/f/forsyth/ez/e3sm-comms-io/input/e3sm_org_reviewer/web_pages.txt
...
echo "Output report: ${IO_DIR}/output/e3sm_org_reviewer/wordpress_sensitive_terms_report.md"
